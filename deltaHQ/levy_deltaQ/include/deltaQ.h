...
#define GEOID_COORD_F0 \
    0.9999                               // scale factor of central
                                         // meridian (m0)
...
#define GEOID_COORD_LAMBDA0 \
    -2.0 // longitude of true origin and
         // central meridian
#endif
...
double initial_latitude(
    double North, double n0, double aF0, double phi0, double n, double bF0);
