...
double system_bandwidth_array[WIMAX_SYS_BW_NUMBER] = {
    SYS_BW_1, SYS_BW_3, SYS_BW_5, SYS_BW_7, SYS_BW_8, SYS_BW_10, SYS_BW_20};
// MCS values and selection array
int mcs_array[WIMAX_RATES_NUMBER] = {QPSK_18,  QPSK_14,  QPSK_12,  QPSK_34,
                                     QAM16_12, QAM16_23, QAM16_34, QAM64_12,
                                     QAM64_23, QAM64_34, QAM64_56};
...
int main(void) {
  ...
  for (i = 0; i < MAX_CALCULATION_BW; i++) {
    ...
    system_bandwidth = system_bandwidth_array[system_bandwidth_select_array[i]];
    ...
    if (capacity_update_all(&capacity, system_bandwidth,
                            mcs_array[mcs_select_array[0]], MIMO_TYPE_SISO, 1,
                            1) == ERROR) {
...
(dl_symbols=%d ul_symbols=%d)",
             system_bandwidth, capacity.dl_symbols, capacity.ul_symbols);
