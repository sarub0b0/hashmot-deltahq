...
int io_write_nam_motion_header_to_file(struct node_class *nodes,
                                       int node_number,
                                       FILE *motion_file);

// write motion file information in NAM format;
// return SUCCESS on succes, ERROR on error
int io_write_nam_motion_info_to_file(struct node_class *nodes,
                                     int node_number,
                                     FILE *motion_file,
                                     float time);
...
// return SUCCESS on succes, ERROR on error
int io_write_ns2_motion_header_to_file(struct node_class *nodes,
                                       int node_number,
                                       FILE *motion_file);

// write header of motion file in NS-2 format;
// return SUCCESS on succes, ERROR on error
int io_write_ns2_motion_header_to_file_new(struct node_class *nodes,
                                           int node_number,
                                           FILE *motion_file,
                                           float time);
...
// write motion file information in NAM format;
// return SUCCESS on succes, ERROR on error
int io_write_ns2_motion_info_to_file(struct node_class *nodes,
                                     int node_number,
                                     FILE *motion_file,
                                     float time);
...
// write motion file information in NAM format;
// return SUCCESS on succes, ERROR on error
int io_write_ns2_motion_info_to_file_new(struct node_class *nodes,
                                         int node_number,
                                         FILE *motion_file,
                                         float time);
...
void io_binary_print_time_record(
    struct binary_time_record_class *binary_time_record, FILE *logfd);
...
// return SUCCESS on succes, ERROR on error
int io_binary_read_header_from_file(struct binary_header_class *binary_header,
...
// return SUCCESS on succes, ERROR on error
int io_binary_read_time_record_from_file(
    struct binary_time_record_class *binary_time_record,
    FILE *binary_input_file);

// write a time record of QOMET binary output file;
// return SUCCESS on succes, ERROR on error
int io_binary_write_time_record_to_file(float time,
                                        int record_number,
                                        FILE *binary_file);

// directly write a time record of QOMET binary output file;
// return SUCCESS on succes, ERROR on error
int io_binary_write_time_record_to_file2(
    struct binary_time_record_class *binary_time_record, FILE *binary_file);

// read a record of QOMET binary output file;
// return SUCCESS on succes, ERROR on error
int io_binary_read_record_from_file(struct binary_record_class *binary_record,
                                    FILE *binary_input_file);

// read 'number_records' records from a QOMET binary output file;
// return SUCCESS on succes, ERROR on error
int io_binary_read_records_from_file(struct binary_record_class *binary_records,
                                     int number_records,
                                     FILE *binary_input_file);
...
// return SUCCESS on succes, ERROR on error
int io_binary_write_record_to_file2(struct binary_record_class *binary_record,
                                    FILE *binary_file);
