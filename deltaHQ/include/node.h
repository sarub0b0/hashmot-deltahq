...
// antenna parameters
       ...
       double azimuth_orientation;        // orientation in horizontal plane
       wrt 0x axis double azimuth_beamwidth;  // beamwidth in horizontal plane
       // (angle at which power is halfed <=> 3dB drop)
       double elevation_orientation;      // orientation in vertical plane wrt
       0x axis
