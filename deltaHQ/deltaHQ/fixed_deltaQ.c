...
void fixed_deltaQ_init(struct fixed_deltaQ_class *fixed_deltaQ,
                       double start_time, double end_time, double bandwidth,
                       double loss_rate, double delay, double jitter) {
...
loss_rate=%.4f delay=%.4f jitter=%.4f\n",
           fixed_deltaQ->start_time, fixed_deltaQ->end_time,
           fixed_deltaQ->bandwidth, fixed_deltaQ->loss_rate,
           fixed_deltaQ->delay, fixed_deltaQ->jitter);
}
